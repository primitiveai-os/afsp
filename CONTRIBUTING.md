...
Any organization may submit an extension proposal by [opening an issue with the Extension proposal template](https://github.com/primitiveai-os/afsp/issues/new?template=extension-proposal.yml). The template applies the `extension-proposal` label automatically.
